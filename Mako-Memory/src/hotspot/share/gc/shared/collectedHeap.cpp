...
void CollectedHeap::fill_args_check(HeapWord* start, size_t words)
{
  ...
  assert(Universe::heap()->is_in_reserved(start) || Universe::semeru_heap()->is_in_semeru_reserved(start), "not in heap");
  assert(Universe::heap()->is_in_reserved(start + words - 1) || Universe::semeru_heap()->is_in_semeru_reserved(start + words - 1), "not in heap");
}
 ...
 */ 
	...
	log_debug(heap)("%s, Allocated G1/Shenandoah Memory Pool[0x%llx, 0x%llx] successfully.", __func__, 
