...
AIX_ONLY(public:)               // xlC 12 on AIX doesn't implement C++ DR45.
  ...
  // Modified by Haoran
  static BufferNode* semeru_allocate(size_t size, volatile size_t* index);
...
public:
  ...
  // Modified by Haoran
  bool semeru_not_empty() const { return _completed_buffers_head != NULL && _completed_buffers_head->next()!= NULL;}
