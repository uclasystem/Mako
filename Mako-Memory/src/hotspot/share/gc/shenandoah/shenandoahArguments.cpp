...
#include "gc/shenandoah/shenandoahSemeruCollectorPolicy.hpp" // Modified by Haoran
#include "gc/shenandoah/shenandoahHeap.inline.hpp"
#include "gc/shenandoah/shenandoahSemeruHeap.inline.hpp"  // Modified by Haoran
#include "gc/shenandoah/shenandoahHeapRegion.hpp"
#include "gc/shenandoah/shenandoahSemeruHeapRegion.hpp" // Modified by Haoran
...
CollectedHeap* ShenandoahArguments::create_semeru_heap() {
  ...
  // return NULL;
  tty->print("%s, build the ShenandoahSemeruCollectedHeap policy via ShenandoahArgument \n",__func__);
  ...
  //  return create_heap_with_policy<G1CollectedHeap, G1HeterogeneousCollectorPolicy>();
    ...
    // Modified by Haoran2
    ShenandoahSemeruCollectorPolicy* policy = new ShenandoahSemeruCollectorPolicy();  // 1) Build the specfic CollectorPolicy
    policy->initialize_all();       // Specific GC#CollectorPolicy's initialize_all() function.
    return new ShenandoahSemeruHeap(policy);
    // return create_heap_with_policy<ShenandoahSemeruHeap, ShenandoahSemeruCollectorPolicy>();
  }
}