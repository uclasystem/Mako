...
#ifndef SHARE_GC_SHENANDOAH_SHENANDOAHSEMERUFREESET_HPP
#define SHARE_GC_SHENANDOAH_SHENANDOAHSEMERUFREESET_HPP
...
class ShenandoahSemeruFreeSet : public CHeapObj<mtGC> {
private:
  // Modified by Haoran
  ...
  HeapWord* try_allocate_in(ShenandoahSemeruHeapRegion* region, ShenandoahSemeruAllocRequest& req, bool& in_new_region);
  HeapWord* allocate_single(ShenandoahSemeruAllocRequest& req, bool& in_new_region);
  HeapWord* allocate_contiguous(ShenandoahSemeruAllocRequest& req);

  void flip_to_gc(ShenandoahSemeruHeapRegion* r);
  ...
  void try_recycle_trashed(ShenandoahSemeruHeapRegion *r);

  bool is_empty_or_trash(ShenandoahSemeruHeapRegion *r);
  size_t alloc_capacity(ShenandoahSemeruHeapRegion *r);
  bool has_no_alloc_capacity(ShenandoahSemeruHeapRegion *r);

public:
//   ShenandoahFreeSet(ShenandoahHeap* heap, size_t max_regions);
  // Modified by Haoran
  ShenandoahSemeruFreeSet(ShenandoahSemeruHeap* heap, size_t max_regions);
  ...
  HeapWord* allocate(ShenandoahSemeruAllocRequest& req, bool& in_new_region);
