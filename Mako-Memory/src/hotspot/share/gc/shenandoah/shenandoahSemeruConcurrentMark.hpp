...
#ifndef SHARE_VM_GC_SHENANDOAH_SEMERU_SHENANDOAHCONCURRENTMARK_HPP
#define SHARE_VM_GC_SHENANDOAH_SEMERU_SHENANDOAHCONCURRENTMARK_HPP
...
class ShenandoahSemeruConcurrentMark: public CHeapObj<mtGC> {
...
public:
  ...
  static inline void mark_through_ref(T* p, ShenandoahSemeruHeap* heap, ShenandoahObjToScanQueue* q, ShenandoahMarkingContext* const mark_context);
  template<class T, UpdateRefsMode UPDATE_REFS, StringDedupMode STRING_DEDUP>
  static inline void mark_through_entry(T* p, ShenandoahSemeruHeap* heap, ShenandoahObjToScanQueue* q, ShenandoahMarkingContext* const mark_context);
  template<class T, UpdateRefsMode UPDATE_REFS, StringDedupMode STRING_DEDUP>
  static inline void satb_mark_through_ref(T* p, ShenandoahSemeruHeap* heap, ShenandoahObjToScanQueue* q, ShenandoahMarkingContext* const mark_context);
