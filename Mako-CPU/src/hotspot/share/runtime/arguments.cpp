...
jint Arguments::parse_each_vm_init_arg(const JavaVMInitArgs* args, bool* patch_mod_javabase, JVMFlag::Flags origin) {
  ...
  for (int index = 0; index < args->nOptions; index++) {
    ...
    // Added by Chenxi
        ...
        if (FLAG_SET_CMDLINE(SemeruEnableMemPool, true) != JVMFlag::SUCCESS) {
          return JNI_EINVAL;
        }
      ...
      // 1GB at least.
        ...
        if (FLAG_SET_CMDLINE(EnableBitmap, true) != JVMFlag::SUCCESS) {
          return JNI_EINVAL;
        }
      ...
      if (FLAG_SET_CMDLINE(SemeruMemPoolMaxSize, (size_t)long_max_heap_size) != JVMFlag::SUCCESS) {
        return JNI_EINVAL;
      }
      ...
      if (FLAG_SET_CMDLINE(SemeruMemPoolInitialSize, (size_t)long_max_heap_size) != JVMFlag::SUCCESS) {
        return JNI_EINVAL;
      }
      ...
      if (FLAG_SET_CMDLINE(SemeruMemPoolAlignment, (size_t)long_max_heap_size) != JVMFlag::SUCCESS) {
        return JNI_EINVAL;
      }
    ...
    // SemeruConcGCThreads
      ...
      if (FLAG_SET_CMDLINE(RebuildThreshold, (uint)max_rebuild_threshold) != JVMFlag::SUCCESS) {
        return JNI_EINVAL;
      }
    ...
    // Xmaxf
      ...
      if (FLAG_SET_CMDLINE(SemeruConcGCThreads, (uint)max_semeru_concurrent_threaeds) != JVMFlag::SUCCESS) {
        return JNI_EINVAL;
      }
    // Xmaxf
