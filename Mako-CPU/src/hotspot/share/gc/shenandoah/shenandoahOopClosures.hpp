...
class ShenandoahVerifyHeapRefsClosure : public BasicOopIterateClosure {
private:
  ShenandoahHeap* _heap;
...
public:
  ShenandoahVerifyHeapRefsClosure() :
...
// class ShenandoahRootUpdateHeapRefsClosure : public OopIterateClosure {
// private:
//   ShenandoahHeap* _heap;
...
// public:
//   ShenandoahRootUpdateHeapRefsClosure() :
//     _heap(ShenandoahHeap::heap()) {}
...
private:
  ...
  template <class T>
  void do_oop_work(T* p) {_heap->semeru_maybe_update_with_forwarded(p);}

public:
  ShenandoahSemeruUpdateHeapRefsClosure() :
    _heap(ShenandoahHeap::heap()) {}
