...
#define GC_SHENANDOAH_FLAGS(develop,                                        \
  ...
  experimental(uintx, ShenandoahMinFreeThreshold, 10,                       \
          ...
          range(0,100)                                                      \
                                                                            \
  experimental(uintx, ShenandoahLocalProcessingRatio, 25,                   \
          "Target cache ratio of the whole heap to process locally on the " \
          "CPU server.")                                                    \
          range(0,100)                                                      \
                                                                            \
  ...
  experimental(uintx, ShenandoahEvacReserve, 5,                             \
          ...
          range(1,100)                                                      \
                                                                            \
  experimental(uintx, ShenandoahMaxNumCSet, 16384,                          \
          "MaxNumOfSet")                                                    \
          range(1,32769)                                                    \
                                                                            \
  experimental(size_t, ShenandoahGCLABSize, 32 * K,                         \
          "Max TLAB size to use with Shenandoah GC. Larger value improves " \
  ...
  experimental(bool, ShenandoahPacing, true,                                \
          ...
          "and complete before allocation failure is reached.")             \
                                                                            \
  experimental(bool, ShenandoahSemeruPacing, true,                          \
          "Pace application allocations to give GC chance to start "        \
          "and complete before allocation failure is reached.")             \
                                                                            \
  ...
  experimental(uintx, ShenandoahSATBBufferFlushInterval, 100,               \
          ...
          "Time is in milliseconds.")                                       \
                                                                            \
  experimental(uintx, ShenandoahWriteFlushInterval, 100,                    \
          "Forcefully flush newly allocated objs and modified refs . "      \
          "Time is in milliseconds.")     /*Modified by Haoran*/            \
                                                                            \
  experimental(uintx, IndirectionInitSize, 512 * M,                         \
          "Initial size of indirection table"                               \
          "Size is in bytes.")     /*Modified by Haoran*/                   \
                                                                            \
  experimental(uintx, IndirectionMaxSize, 2048 * M,                         \
          "Max size of indirection table"                                   \
          "Size is in bytes.")     /*Modified by Haoran*/                   \
                                                                            \
