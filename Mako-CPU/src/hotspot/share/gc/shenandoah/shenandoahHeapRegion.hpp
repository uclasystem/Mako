...
public:
  ...
  size_t _state;
  // enum RegionState {
  //   _empty_uncommitted,       // 0
  //   _empty_committed,         // 1
  //   _regular,                 // 2
  //   _humongous_start,         // 3
  //   _humongous_cont,          // 4
  //   _pinned_humongous_start,  // 5
  //   _cset,                    // 6
  //   _pinned,                  // 7
  //   _pinned_cset,             // 8
  //   _trash,                   // 9
  //   _REGION_STATES_NUM        // 10
  // };
...
public:
  ...
  int semeru_state_ordinal() const {
    switch (_state) {
      ...
      case _pinned_humongous_start: return 5;
      case _cset:                   return 6;
      case _pinned:                 return 7;
      case _pinned_cset:            return 8;
      case _trash:                  return 9;
      default:
        ShouldNotReachHere();
        return -1;
    }
