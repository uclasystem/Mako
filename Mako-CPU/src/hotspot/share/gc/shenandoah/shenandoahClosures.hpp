...
private:
  ...
  size_t _worker_id;
public:
  inline ShenandoahEvacuateUpdateRootsClosure(size_t worker_id);
  inline void do_oop(oop* p);
  inline void do_oop(narrowOop* p);
...
class ShenandoahSemeruUpdateRootsClosure: public BasicOopIterateClosure {
private:
  ShenandoahHeap* _heap;
  Thread* _thread;
public:
  inline ShenandoahSemeruUpdateRootsClosure();
  inline void do_oop(oop* p);
  inline void do_oop(narrowOop* p);
...
class ShenandoahSemeruClearBitClosure: public BasicOopIterateClosure {
private:
  ShenandoahHeap* _heap;
  Thread* _thread;
public:
  inline ShenandoahSemeruClearBitClosure();
  inline void do_oop(oop* p);
  inline void do_oop(narrowOop* p);
