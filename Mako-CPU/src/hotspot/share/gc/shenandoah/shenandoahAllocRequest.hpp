...
private:
  ...
  ShenandoahAllocRequest(size_t _min_size, size_t _requested_size, Type _alloc_type, size_t _region_index = 0) :
...
public:
  ...
  // static inline ShenandoahAllocRequest for_gclab(size_t min_size, size_t requested_size, size_t region_index) {
  //   return ShenandoahAllocRequest(min_size, requested_size, _alloc_gclab, region_index);
  // }
  ...
  static inline ShenandoahAllocRequest for_shared_gc(size_t requested_size, size_t region_index) {
    return ShenandoahAllocRequest(0, requested_size, _alloc_shared_gc, region_index);
  }
