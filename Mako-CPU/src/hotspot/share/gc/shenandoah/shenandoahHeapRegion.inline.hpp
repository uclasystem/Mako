...
inline size_t ShenandoahHeapRegion::increase_live_data_gc_words(size_t s) {
  size_t re = internal_increase_live_data(s);
  if (ShenandoahPacing) {
...
inline size_t ShenandoahHeapRegion::internal_increase_live_data(size_t s) {
