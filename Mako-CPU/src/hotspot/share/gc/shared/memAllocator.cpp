...
public:
  ...
  bool allocated_outside_tlab() const { return _allocated_outside_tlab; }
};
...
bool MemAllocator::allocated_outside_tlab(Allocation& allocation) const {
  return allocation._allocated_outside_tlab;
}
